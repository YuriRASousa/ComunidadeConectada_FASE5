...
const doc = new Document({
  sections: [{
    ...
    children: [
      ...
      bullet("Testar a build nativa em um dispositivo físico ou em uma máquina sem o conflito do Vanguard, para validar mapa nativo, câmera e navegação 100% nativa."),
      ...
      bullet("Código-fonte completo: pasta deste projeto (mobile-react-native/, mobile/, backend/, web/) e/ou repositório GitHub — link a acrescentar aqui."),
      bullet("Apresentação de slides (PDF) — arquivo em anexo."),
      bullet("Vídeo de demonstração (até 5 min, YouTube não listado) — link a acrescentar aqui."),
